...
import MARGIN_TYPE_FIELD from '@salesforce/schema/OpportunityLineItem.Margin_Type__c';
import COMMISSION_TYPE_FIELD from '@salesforce/schema/OpportunityLineItem.Commission_Type__c';
import PACKAGING_FIELD from '@salesforce/schema/OpportunityLineItem.Packaging__c';
...
import sendPriceStatusEmails from '@salesforce/apex/PriceStatusEmailHelper.sendPriceStatusEmails';
    ...
    wiredLineItemsResult({ error, data }) {
        if (data) {
            ...
            this.lineItems = data.map(item => {
                ...
                const incoTerms = item.Opportunity.Inco_Terms__c || 'undefined';
    ...
    handleSave() {
        ...
        updateOpportunityLineItems({ lineItems: this.lineItems })
            .then(() => {
                ...
                sendPriceStatusEmails({ oppIds: [this.recordId] })
                    .then(() => {
