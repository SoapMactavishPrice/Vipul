...
import getleadCurrency from '@salesforce/apex/addProductIntrested.getleadCurrency';
import fetchCI from '@salesforce/apex/MarketingForm.fetchCI';
import getUnits from '@salesforce/apex/addProductIntrested.getUnits';


export default class ProductInterestedOnLead extends NavigationMixin(LightningElement) {
    @api recordId;
    ...
    //     if (data) {
    //         console.log('Picklist Data:', data);  // Debugging the returned picklist data
    //         this.packagingOptions = data.map(item => ({
    //             label: item.label,
    //             value: item.value
    //         }));
    //         this.uomOptions = data.map(item => ({
    //             label: item.label,
    //             value: item.value
    //         }));
    //         console.log(' this.uomOptions', this.uomOptions);
    //         console.log(' this.packagingOptions', this.packagingOptions);
    ...
    @wire(getleadCurrency, { leadId: '$recordId' })
